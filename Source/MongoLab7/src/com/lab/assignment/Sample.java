...
public class Sample extends HttpServlet {
	...
	public String example(){
        ...
        */
		...
		DBCollection users = db.getCollection("assignment7");
		BasicDBObject query = new BasicDBObject();
		query.put("name","akhilesh");// request.getParameter("name"));
		query.put("password","akhilesh"); //request.getParameter("password"));
